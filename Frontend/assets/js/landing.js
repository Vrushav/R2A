...
duration:500
    ...
    <div class="receipt">
        ...
        <p><strong>${t.labels.patientName} :</strong> ${patient.name}</p>

        <p><strong>Family Member :</strong>${patient.familyMember}</p>

        <p><strong>${t.labels.appointmentID} :</strong> ${patient.appointmentID}</p>

        <p><strong>${t.labels.patientID} :</strong> ${patient.patientID}</p>

        ${patient.abha ? `<p><strong>ABHA ID :</strong> ${patient.abha}</p>` : ""}

        <p><strong>${t.labels.village} :</strong> ${patient.village}</p>

        <p><strong>${t.labels.hospital} :</strong> ${patient.hospital}</p>

        <p><strong>${t.labels.department} :</strong> ${patient.department}</p>

        <p><strong>${t.labels.doctor} :</strong> ${patient.doctor}</p>

        <p><strong>${t.labels.date} :</strong> ${patient.date}</p>

        <p><strong>${t.labels.time} :</strong> ${patient.slot}</p>

        <p><strong>${t.labels.token} :</strong> ${patient.token}</p>

        <p><strong>Estimated Waiting :</strong>${appointments.length*8} Minutes</p>

        <p><strong>${t.labels.status} :</strong> ${patient.status}</p>
...
function completeAppointment(token){
